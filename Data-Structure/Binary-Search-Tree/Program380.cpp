    ...
    public:
        ...
        int SumRightChild(PNODE temp)
        {
            ...
            if(temp != NULL)
            {
                if(temp -> rchild != NULL)
                {
                    iCount = iCount + temp -> rchild -> data;
                }
                SumRightChild(temp -> lchild);
                SumRightChild(temp -> rchild);
            }
            return iCount;
        }
        void ResetSumRightChild()
        {
            SumRightChild(NULL);
        }
        
        int Height(PNODE temp)
        {
            ...
            ileft = Height(temp -> lchild);
            iright = Height(temp -> rchild);
...
int main()
{
    ...
    obj.ResetSumRightChild();
    iRet = obj.SumRightChild(obj.head);
    cout<<"Sum Of Right child is : "<<iRet<<"\n";
    
    obj.ResetHeight();
    iRet = obj.Height(obj.head);
    cout<<"Height of BST is : "<<iRet<<"\n";
